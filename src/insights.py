...
def get_unique_job_types(path):
    ...
    """
    data = read(path)
    jobs = {item['job_type'] for item in data}
    return jobs
...
def filter_by_job_type(jobs, job_type):
    ...
    """
    avaliable_jobs = [job for job in jobs if job['job_type'] == job_type]
    return avaliable_jobs
...
def filter_by_industry(jobs, industry):
    ...
    """
    avaliable_jobs = [job for job in jobs if job['industry'] == industry]
    return avaliable_jobs
...
def get_min_salary(path):
    ...
    data = read(path)
    m = 'min_salary'
    m_salary = [int(item[m]) for item in data if item[m].isdigit()]
    return min(m_salary)
