...
def matches_salary_range(job, salary):
    ...
    """
    """
    Material consultado para verificar se chave existe em dicionário
    https://stackoverflow.com/questions/1602934/check-if-a-given-key-already-exists-in-a-dictionary
    """
    if (
        "min_salary" not in job or "max_salary" not in job or
...
def filter_by_salary_range(jobs, salary):
    ...
    """
    """
    Material consultado sobre como tratar o erro ao construir a lista
    https://stackoverflow.com/a/1528286
    """
    filtered_jobs = []
    for job in jobs:
        try:
